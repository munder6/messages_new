...
import '../../../features/domain/entities/message.dart';
import '../../../features/domain/entities/user.dart';
import '../../../features/presentation/views/camera/camera_screen.dart';
import '../../../features/presentation/views/camera/camera_story_screen.dart';
...
class Routes {
  ...
  static const String cameraStoryRoute = '/camera-story';
...
class AppRoutes {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.chatRoute:
        ...
        return MaterialPageRoute(
          builder: (_) {
            ...
            return ChatScreen(name: name,uId: uId,);
            },
        );
      ...
      case Routes.cameraStoryRoute:
        final arguments =settings.arguments as Map<String,dynamic>;
        //final String name =arguments['name'];
        final String uId = arguments['uId'];
        return MaterialPageRoute(
          builder: (_) =>  CameraStoryScreen(receiverId: uId),
        );
